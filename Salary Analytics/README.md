...
As a newbie in the data world, I wondered what was the most optimal job for a pharmacist and what skills I would need to land a job in such a role. I was surprised by the lack of data exploring the most optimal jobs and skills in the data science market. I set out to understand what skills top employers request and how to land a higher pay.
...
The dataset used for this project contains real-world data science job information from 2023. The dataset is available on Luke Barousse Excel course on YouTube, which provides a foundation for analyzing data using Excel. 
...
- 🧹 Since I had already cleaned the data using Power Query, by using Power Pivot, I created a relationship between these two tables.
